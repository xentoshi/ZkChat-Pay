...
// import PrivateKeyProviderConnector from '@0x/subproviders/lib/src/providers/private_key_subprovider'
  ...
  return (
    <form onSubmit={handleSubmit}>
      <FormControl id="fromTokenAddress" isRequired>
        ...
        <Input type="text" value={fromTokenAddress} onChange={event => setFromTokenAddress(event.target.value)} />
      </FormControl>

      <FormControl id="toTokenAddress" isRequired>
        <FormLabel>To Token Address</FormLabel>
        <Input type="text" value={toTokenAddress} onChange={event => setToTokenAddress(event.target.value)} />
      </FormControl>
      ...
      <FormControl id="walletAddress" isRequired>
        ...
        <Input type="text" value={walletAddress} onChange={event => setWalletAddress(event.target.value)} />
      </FormControl>
